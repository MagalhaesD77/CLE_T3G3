...
void \mbox{\hyperlink{sharedRegion_8h_aad2bcb0c42457c1ff6e3e734e64392db}{get\+Data}} (unsigned int worker\+Id, char $\ast$buffer, int $\ast$return\+Status, int $\ast$current\+File\+Index)
...
\begin{DoxyCompactList}\small\item\em Add the partial counting results from a thread for a file to the shared region. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{sharedRegion_8h_aad2bcb0c42457c1ff6e3e734e64392db}\label{sharedRegion_8h_aad2bcb0c42457c1ff6e3e734e64392db}} 
...
{\footnotesize\ttfamily void get\+Data (\begin{DoxyParamCaption}\item[{unsigned int}]{worker\+Id,  }\item[{char $\ast$}]{buffer,  }\item[{int $\ast$}]{return\+Status,  }\item[{int $\ast$}]{current\+File\+Index }\end{DoxyParamCaption})}
